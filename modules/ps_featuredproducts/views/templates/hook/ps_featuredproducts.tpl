<section class="featured-products position-relative mb-4 clearfix">
  ...
  <div class="featured-products-list position-relative">
    <div class="featured-controls slider-controls">
      <div class="featured-control-left slider-control-left"><i class="material-icons">&#xE314;</i></div>
      <div class="featured-control-right slider-control-right"><i class="material-icons">&#xE315;</i></div>
    </div>
