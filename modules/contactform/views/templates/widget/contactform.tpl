  ...
  <form action="{$urls.pages.contact}" method="post" {if $contact.allow_file_upload}enctype="multipart/form-data"{/if}>
    ...
    {if !$notifications || $notifications.nw_error}
      <section class="form-fields">
        ...
        <div class="form-group row">
          <label class="col-md-3 form-control-label text-left text-md-right">{l s='Subject' d='Shop.Forms.Labels'}</label>
          <div class="col-md-6">
      ...
      <footer class="form-footer text-sm-right">
        ...
        <input class="btn btn-primary rounded" type="submit" name="submitMessage" value="{l s='Send' d='Shop.Theme.Actions'}">
      </footer>
    {/if}
